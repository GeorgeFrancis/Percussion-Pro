...
#import "CongaSequencerViewController.h"


@interface CongaSequencerViewController ()

@end

@implementation CongaSequencerViewController
...
-(void)playBeat{
    ...
    if (self.timerCounter == 4.25) {
        ...
        [self.timerBarImage setFrame:CGRectMake(23, 142, self.timerBarImage.frame.size.width, self.timerBarImage.frame.size.height)];
